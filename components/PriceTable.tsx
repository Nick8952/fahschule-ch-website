...
export default function PriceTable() {
  ...
  return (
    <div>
      ...
      <p className="mt-3 text-[0.84rem] text-ink-faint">{prices.disclaimer}</p>
    </div>
  );
}
